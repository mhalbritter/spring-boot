...
class ZipkinConfigurationsOpenTelemetryConfigurationTests {
	...
	// .withConfiguration(AutoConfigurations.of(DefaultEncodingConfiguration.class,
	// OpenTelemetryConfiguration.class));
	//
	// @Test
	// void backsOffWithoutEncoding() {
	// new
	// ApplicationContextRunner().withUserConfiguration(OpenTelemetryConfiguration.class).run((context)
	// -> {
	...
	// FilteredClassLoader("io.opentelemetry.exporter.zipkin"))
	...
	// this.contextRunner
	// .withUserConfiguration(SenderConfiguration.class,
	// CustomEncodingConfiguration.class,
	// CustomEncoderConfiguration.class)
	// .run((context) -> {
	// assertThat(context).hasSingleBean(ZipkinSpanExporter.class);
	// assertThat(context).hasBean("customSpanEncoder");
