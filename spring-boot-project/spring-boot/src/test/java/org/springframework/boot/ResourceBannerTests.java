...
class ResourceBannerTests {
	...
	private String printBanner(ResourceBanner banner, String applicationVersion, String applicationTitle) {
		MockEnvironment environment = new MockEnvironment();
		if (applicationVersion != null) {
			environment.setProperty("spring.application.version", applicationVersion);
		}
		if (applicationTitle != null) {
			environment.setProperty("spring.application.title", applicationTitle);
		}
	...
	static class MutatingResourceBanner extends MockResourceBanner {
		...
		MutatingResourceBanner(Resource resource, String bootVersion) {
			super(resource, bootVersion);
		}
