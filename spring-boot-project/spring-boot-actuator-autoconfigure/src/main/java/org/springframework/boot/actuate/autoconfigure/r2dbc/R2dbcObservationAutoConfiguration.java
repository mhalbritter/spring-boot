...
public class R2dbcObservationAutoConfiguration {
	...
	ConnectionFactoryDecorator connectionFactoryDecorator(
			R2dbcObservationProperties properties,
	...
	private String extractUrl(ConnectionFactory connectionFactory) {
		// TODO: How to get the URL from the connection factory?
		...
		// It would be better if OptionsCapableConnectionFactory would accept host / port directly instead of parsing the port
