...
final class JettyThreadPool {
	...
	static int maxThreadCount(ServerProperties.Jetty.Threads properties) {
		return (properties.getMax() > 0) ? properties.getMax() : 200;
	}
	...
	static QueuedThreadPool create(ServerProperties.Jetty.Threads properties) {
		...
		int maxThreadCount = maxThreadCount(properties);
