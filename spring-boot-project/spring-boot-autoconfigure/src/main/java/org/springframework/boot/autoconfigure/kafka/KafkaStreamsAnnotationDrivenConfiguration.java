...
class KafkaStreamsAnnotationDrivenConfiguration {
	...
	private void applyKafkaConnectionDetailsForStreams(Map<String, Object> properties,
		...
		KafkaAutoConfiguration.applySecurityProtocol(properties, connectionDetails.getStreamsSecurityProtocol());
		KafkaAutoConfiguration.applySslBundle(properties, connectionDetails.getStreamsSslBundle());
	}
