...
abstract class AbstractLaunchScriptIntegrationTests {
	...
	static {
		...
		urls.put(Architecture.AMD64, URI.create(
				"https://github.com/bell-sw/Liberica/releases/download/17.0.8%2B7/bellsoft-jdk17.0.8+7-linux-amd64.tar.gz"));
		urls.put(Architecture.AARCH64, URI.create(
				"https://github.com/bell-sw/Liberica/releases/download/17.0.8%2B7/bellsoft-jdk17.0.8+7-linux-aarch64.tar.gz"));
