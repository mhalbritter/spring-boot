...
class OnClassCondition extends FilteringSpringBootCondition {
	...
	@Override
	protected final @Nullable ConditionOutcome[] getOutcomes(String[] autoConfigurationClasses,
	...
	private @Nullable ConditionOutcome[] resolveOutcomesThreaded(String[] autoConfigurationClasses,
			AutoConfigurationMetadata autoConfigurationMetadata) {
	...
	private static final class StandardOutcomesResolver implements OutcomesResolver {
		...
		private @Nullable ConditionOutcome[] getOutcomes(String[] autoConfigurationClasses, int start, int end,
				AutoConfigurationMetadata autoConfigurationMetadata) {
